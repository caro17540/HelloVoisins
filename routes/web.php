...
//Route::resource('user', 'UserController');
    ...
    Route::get('/user/{n}', 'UserController@show')->where('n','[0-9]+')->name('user.show');          //**AFFICHAGE DES DONNEES DU USER n**
...
Route::get('/transaction/create/{m}/{n}', 'TransactionController@create')->name('transaction_create');
